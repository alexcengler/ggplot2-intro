...
enr <- read.csv(file.choose(), header = TRUE)
# OR:
...
# Which makes ggplot + Illustrator a powerful combination
## Remember to export to PDF if you want to edit a graph in Illustrator
...
## Additional examples (and faceting):
data(Orange)
head(Orange)
